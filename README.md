...
### AI mode
Once the game has launched a left-click inside the game-frame starts the simulation. Another left click resets the simulation progress by killing all individuals.
